...
- Provider scanning runs against local directories configured by `AGENT_BADGE_CODEX_DIR`, `AGENT_BADGE_CLAUDE_DIR`, and `AGENT_BADGE_GROK_DIR`, defaulting to `~/.codex`, `~/.claude`, and `GROK_HOME` or `~/.grok`.
